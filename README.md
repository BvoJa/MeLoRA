...
| `run_vietmed_ner_phobert.py` | Script huấn luyện/evaluate/predict PhoBERT cho VietMed-NER. |
| `vietmed_ner_phobert.sh` | Script bash cấu hình sẵn thí nghiệm PhoBERT + MELoRA cho VietMed-NER. |
